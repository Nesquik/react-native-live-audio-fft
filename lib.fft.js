// ref to https://github.com/xiangyuecn/Recorder/blob/1.2.23070100/src/extensions/lib.fft.js
...
*/
export default function (bufferSize) {
  'use strict';
  ...
  var FFT_Fn = function (bufSize) {
    //bufSize只能取值2的n次方
    FFT_N_LOG = Math.round(Math.log(bufSize) / Math.log(2));
    FFT_N = 1 << FFT_N_LOG;
